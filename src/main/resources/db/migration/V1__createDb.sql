...
--create table license (id serial not null, acrynosm varchar(255), details varchar(1024), name varchar(255), reference_link varchar(255), primary key (id))
...
--create table product_details (product_id bigint not null, version varchar(255) not null, cover_image varchar(255), upload_date timestamp(6), description varchar(100), detail_description varchar(255), draft boolean, instruction varchar(255), last_update timestamp(6), name varchar(30), price integer, category_id integer, license_id integer, primary key (product_id, version))
--create table product_details_tag (product_id bigint not null, version varchar(255) not null, tag_id integer not null)
--create table products (id bigint not null, active_version varchar(255), enabled boolean, seller_id bigint not null, primary key (id))
