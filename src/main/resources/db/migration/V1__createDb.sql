...
END $$;
 ...
 create table contacts (id bigint not null,firstname varchar(255),lastname varchar(255), created_date timestamp(6) not null,phone varchar(255) not null, address varchar(255) not null,message varchar(255) not null, email varchar(255) not null, primary key (id));
