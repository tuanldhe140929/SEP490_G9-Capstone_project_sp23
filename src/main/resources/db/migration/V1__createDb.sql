...
END $$;
 ...
 create table product_details (product_id bigint not null, version varchar(255) not null, cover_image varchar(255), upload_date timestamp(6), status Status not null, description varchar(100), detail_description varchar(255), instruction varchar(255), last_update timestamp(6), name varchar(30), price real, category_id integer, engine_id integer, license_id integer, primary key (product_id, version));
